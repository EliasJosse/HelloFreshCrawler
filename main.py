...
titles_end = title_elements.index('Vegetariska Recept')
#creates an index for where the recipe titles end
titles = title_elements[1:titles_end]
...
filtered = [string for string in text_elements2 if type(string) is str and len(string) > 60]
